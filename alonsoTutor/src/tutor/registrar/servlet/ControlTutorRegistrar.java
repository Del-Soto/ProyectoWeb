package tutor.registrar.servlet;
...
@WebServlet("/registrarTutor")


public class ControlTutorRegistrar extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException{
				...
				else
				{
					...
					String respuesta = b1.resgitartutor(tutor1);
					
					if(respuesta =="registro correctamente")
					{
