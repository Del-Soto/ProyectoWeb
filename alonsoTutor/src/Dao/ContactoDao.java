...
public class ContactoDao extends BDConnection{
	...
	public Integer actualizaPersona(Contacto contacto) {
	...
	public Integer borrar(Contacto contacto) {
		System.out.println("--->"+contacto.getId());
		try {
			int id = contacto.getId();
	...
	public Contacto findbyId(int id)
	{
		...
		try
		{
			...
			if(connection != null)
			{
				String query = "select * from contacto where idContacto=? and telefono=?";
